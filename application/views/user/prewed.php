...
<div class="container-fluid">
    ...
    <div class="form-group">
        ...
        <input type="hidden" class="form-control" id="formGroupExampleInput" placeholder="Nama" value="Prewedding"
            name="jenis_jasa">
        ...
        <div class="col-4">
            <div class="form-group">
                ...
                <select class="form-control" name="paket">
                    ...
                    <option>PAKET A | 2 Jam | Rp.2.500.000</option>
                    <option>PAKET B | 3 Jam | Rp.3.000.000</option>
                    <option>PAKET C | 4 Jam | Rp.3.500.000</option>
                </select>
            </div>
        </div>
        <div class=" col-4">
