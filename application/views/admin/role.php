...
<div class="row">
    <div class="col-lg-11">
        ...
        <a href="" class="btn btn-dark btn-sm btn-block ml-4 mb-4" data-toggle="modal" data-target="#roleModal">Tambah
            Role</a>
            ...
            <form action="<?= base_url('admin/role'); ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control" id="role" placeholder="Nama Role" name="role">
                    </div>
                </div>
